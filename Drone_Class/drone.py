...
class Drone:
    ...
    #Note: If you try to use this in a distance that is greater than the amount of ground that is
    #available, the drone WILL try to peform an action that it cannot and enter a loop.
